...
* On the cognitive and computational side, my recent work explores if self-supervised learning, knowledge distillation, and vision-language alignment can provide the necessary inductive biases that allow models to learn holistic shape representations. This work demonstrates when and why certain architectures develop human-like sensitivity to the configural relations between object parts.

* On the mechanistic side, we build a decomposition framework that disentangles how Vision Transformers exchange positional and semantic information through specialized modes of the attention mechanism, extracted via a spectral factorization of the query–key interaction. This lets us isolate the underlying circuits that drive the model’s internal information flow.

* On the brain and behavior side, I explore the tuning and spatial topography of visual representations, examining how mid-level mechanisms support the emergence of object shape information across human and model representations. This work links perceptual organization in humans with representational signatures that emerge in vision models.
